...
Ex2.3
The action value would go random walk every 20 steps. The result is shown in figure Ex2.3.pdf. I omit the first 10 steps since it will always choose the first action which is best at the first step. I have test the program in the condition of Fig2.2 and get similar results.
